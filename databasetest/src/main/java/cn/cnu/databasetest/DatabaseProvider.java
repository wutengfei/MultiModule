...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "cn.cnu.databasetest.provider";
...
// 删除数据
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.cn.cnu.databasetest.provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.cn.cnu.databasetest.provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.cn.cnu.databasetest.provider.category";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.cn.cnu.databasetest.provider.category";
        }
        return null;
    }
